		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comerosadvancepayment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comerosadvancepayment-display": {
								"semanticObject": "comerosadvancepayment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.eros.advancepayment",
									"url": sap.ui.require.toUrl("com/eros/advancepayment")
								}
							}
						}
					}
